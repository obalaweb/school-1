	...
	if (jQuery('.pbmit-element-viewtype-masonry').length > 0) {
		jQuery('.pbmit-element-viewtype-masonry').each(function() {
			...
			let $grid = jQuery('.pbmit-element-posts-wrapper', main_ele).masonry({
				...
				itemSelector: '.pbmit-blog-style-1',
				columnWidth: '.pbmit-blog-style-1',
				gutter: 0,
...
if( $('#pbmit-clock').length>0 ){
	$('#pbmit-clock').countdown('2024/10/10', function(event) {
		...
		+ '<div class="count-time"><span class="countdown-amount">86</span><span class="countdown-period">Days</span></div>'
		+ '<div class="count-time"><span class="countdown-amount">05</span><span class="countdown-period">Hours</span></div> '
		+ '<div class="count-time"><span class="countdown-amount">33</span><span class="countdown-period">Minutes</span></div>'
		+ '<div class="count-time"><span class="countdown-amount">%S</span><span class="countdown-period">Seconds</span></div>'
		));
	});
}
